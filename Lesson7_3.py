...
# соответствующий количеству клеток (целое число). В классе должны быть реализованы методы перегрузки
...
# переданному аргументу. Если ячеек на формирование ряда не хватает,
...
class Ceel:
    ...
    def __sub__(self, other):
        if self.n_cells > other.n_cells:
            ...
            print(f'Операция вычитаний клеток невыполнима, так как в первой клетке меньше ячеек, чем во второй')
